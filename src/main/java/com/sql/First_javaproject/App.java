...
public class App {
	public static void main(String[] args) {
		...
		String discountPath = "src/main/java/resources/discount.json";
		...
		try {
			// Read trasaction
			List<Transaction> transactions = service.readTransactions(validOutputPath);
			...
			// Write valid and invalid transactio
